    ...
    private function getGroupInfo($g_id, $userId)
    {
        ...
        if($recentMessage!=null){
            ...
            if((int)$recentMessage->sender==(int)$userId){
                ...
                $name=$this->User_Model->get_user((int)(int)$recentMessage->sender,null,null)['firstName'];
...
if($recentMessage!=null){
    ...
    public function updateGroupImage_post(){
        ...
        $image = null;
        $fileType = null;
        $actualFolderName = "./assets/im/group_$groupId";
        $actualFileName=null;
        ...
        if (isset($_FILES['file']['tmp_name']) && !empty($_FILES['file']['tmp_name'])) {
            if (!$this->upload->do_upload('file')) {
                ...
                $imageUrl= base_url() . "assets/im/group_".$groupId."/".$image;
                $socketData = array(
                    "g_id" => $groupId,
                    "memberIds" => $memberIds,
                    "imageData" => [$imageUrl],
