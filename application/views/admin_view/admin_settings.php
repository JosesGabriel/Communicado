    ...
    jQuery(document).ready(function ($) {
       ...
       // validator.form();
        ...
        $('#searchEmailBtn').on('click',function (e) {
            ...
            location.href="<?php echo base_url('admin/adminSettings').'?search='?>"+email;
        });
        $('#clearBtn').on('click',function () {
            location.href="<?php echo base_url('admin/adminSettings')?>";
        });
        $('#newAdminForm').on('submit',function (e) {
           ...
           if($(this).valid()) {
               ...
               var settings = {
                   "async": true,
                   "crossDomain": true,
                   "url": "<?php echo base_url('adminApi/createAdmin') ?>",
                   "method": "POST",
                   "headers": {
                       "authorization": "Basic YWRtaW46MTIzNA==",
                       "Authorizationkeyfortoken": String(t),
                       "cache-control": "no-cache",
                       "postman-token": "19d22d97-f652-301a-e59f-391c90cd44da"
                   },
                   "processData": false,
                   "contentType": false,
