    ...
    $(document).ready(function () {
        ...
        function getImagePreview(message){
            ...
            if(linkData!=null && linkData.hasOwnProperty("playerOrImageUrl") && linkData.playerOrImageUrl.hasOwnProperty("size") && linkData.playerOrImageUrl.size!=null && linkData.playerOrImageUrl.size.hasOwnProperty("height") && linkData.playerOrImageUrl.size.height!=null &&linkData.playerOrImageUrl.size.hasOwnProperty("width") && linkData.playerOrImageUrl.size.width!=null ){
                html = "<div id='message_" + message.m_id + "' class=\"fw-im-attachments\"><a style='display: inline-block;border: 1px solid #eee;border-radius: 10px;max-height: 450px;' href=\"" + linkData.playerOrImageUrl.url + "\"  class=\"ol-hover hover-5 ol-lightbox\"><img onerror='this.style.display=\"none\";' style='max-height: 450px;' height=\""+linkData.playerOrImageUrl.size.height+"px\" width=\""+linkData.playerOrImageUrl.size.width+"px\" src=\"" + linkData.playerOrImageUrl.url + "\" alt=\"image hover\">";
            }
