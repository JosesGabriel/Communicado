...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        */
        ...
        function saveImageLocalStorage(groupId){
            ...
            if (groupObjects[groupId].groupImage.length === 1) {
                localStorage.setItem('g_image',groupObjects[groupId].groupImage[0])
                    ...
                    return function () {
                        ...
                        imageObj2.onload = (function (groupId,cb) {
                            return function () {
                                ...
                                localStorage.setItem('g_image',c.toDataURL("image/png"));
