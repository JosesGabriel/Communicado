...
<section class="page-contents">
    ...
    <div class="middleSection col-xl-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
        <div class="chat-search col-md-12 groupNameDiv" style="text-align: left; padding-bottom: 21px;">
            <div class="col-md-2 col-xl-2 col-sm-2 col-xs-2" style="text-align: left;cursor: pointer;">
                <a href="<?php echo base_url('mobile/im') ?>" style="color: #75aef3"> <i class="fa fa-arrow-left"></i> </a>
            </div>
            <div class="col-md-8 col-xl-8 col-xs-8 col-sm-8 text-center">
