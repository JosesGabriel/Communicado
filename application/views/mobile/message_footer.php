    ...
    $(document).ready(function () {
        ...
        function getImagePreview(message){
            ...
            if(linkData!=null && linkData.hasOwnProperty("playerOrImageUrl") &&linkData.playerOrImageUrl.hasOwnProperty("size") && linkData.playerOrImageUrl.size!=null && linkData.playerOrImageUrl.size.hasOwnProperty("height") && linkData.playerOrImageUrl.size.height!=null &&linkData.playerOrImageUrl.size.hasOwnProperty("width") && linkData.playerOrImageUrl.size.width!=null ){
                html = "<div id='message_" + message.m_id + "' class=\"fw-im-attachments\"><a style='display: inline-block;margin-left: auto;border: 1px solid #eee;border-radius: 10px;' href=\"" + linkData.playerOrImageUrl.url + "\"  class=\"ol-hover hover-5 ol-lightbox\"><img onerror='this.style.display=\"none\";' style='border: 1px solid #eee;border-radius: 10px; max-height: 230px;max-width: 240px;width: "+linkData.playerOrImageUrl.size.width+"px;height: "+linkData.playerOrImageUrl.size.height+"px;'  src=\"" + linkData.playerOrImageUrl.url + "\" alt=\"image hover\">";
            }
        ...
        function getMessage(groupId) {
            ...
            let settings = {
                ...
                "beforeSend": function () {
                    ...
                    messageLoading = true;
                    chatBox.html('<img id="loadingMessage" src="<?php echo base_url('assets/img/loadingMessage.gif'); ?>" class="img-responsive blankImg" style="width:500px;margin-top: 20px;">');
