...
<head>
    ...
    <link href="<?php echo base_url("assets/newTheme/assets/css/magicsuggest.css")."?".rand(5,50000); ?>" rel="stylesheet" type="text/css"><link href="<?php echo base_url("assets/newTheme/assets2/custom2.css")."?".rand(5,50000); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo base_url("assets/newTheme/assets2/style_chat.css")."?".rand(5,50000); ?>" rel="stylesheet" type="text/css">
